...
% Regressor_Matrix (3,2)  = Get_Cof(Torque(3),m2,cm2_x);
% Regressor_Matrix (3,3)  = Get_Cof(Torque(3),m2,cm2_y);
...
% Regressor_Matrix (3,20) = Get_Cof(Torque(3),m7,L2);
...
% Regressor_Matrix (4,2)  = Get_Cof(Torque(4),m2,cm2_x);
% Regressor_Matrix (4,3)  = Get_Cof(Torque(4),m2,cm2_y);
% Regressor_Matrix (4,4)  = Get_Cof(Torque(4),m3,L3);
%Regressor_Matrix (4,5)  = Get_Cof(Torque(4),m3,cm3_z);
% Regressor_Matrix (4,6)  = Get_Cof(Torque(4),m4,L3);
%Regressor_Matrix (4,7)  = Get_Cof(Torque(4),m4,cm4_y);
Regressor_Matrix (4,8)  = Get_Cof(Torque(4),m4,cm4_x);
Regressor_Matrix (4,9)  = Get_Cof(Torque(4),m4,cm4_z);
% Regressor_Matrix (4,10) = Get_Cof(Torque(4),m5,L3);
%Regressor_Matrix (4,11) = Get_Cof(Torque(4),m5,L4_z0);
...
% Regressor_Matrix (4,15) = Get_Cof(Torque(4),m6,L3);
%Regressor_Matrix (4,16) = Get_Cof(Torque(4),m6,L4_z0);
...
% Regressor_Matrix (4,20) = Get_Cof(Torque(4),m7,L2);
% Regressor_Matrix (4,21) = Get_Cof(Torque(4),m7,L3);
%Regressor_Matrix (4,22) = Get_Cof(Torque(4),m7,L4_z0);
...
% Regressor_Matrix (5,2)  = Get_Cof(Torque(5),m2,cm2_x);
% Regressor_Matrix (5,3)  = Get_Cof(Torque(5),m2,cm2_y);
% Regressor_Matrix (5,4)  = Get_Cof(Torque(5),m3,L3);
% Regressor_Matrix (5,5)  = Get_Cof(Torque(5),m3,cm3_z);
% Regressor_Matrix (5,6)  = Get_Cof(Torque(5),m4,L3);
% Regressor_Matrix (5,7)  = Get_Cof(Torque(5),m4,cm4_y);
% Regressor_Matrix (5,8)  = Get_Cof(Torque(5),m4,cm4_x);
% Regressor_Matrix (5,9)  = Get_Cof(Torque(5),m4,cm4_z);
% Regressor_Matrix (5,10) = Get_Cof(Torque(5),m5,L3);
% Regressor_Matrix (5,11) = Get_Cof(Torque(5),m5,L4_z0);
Regressor_Matrix (5,12) = Get_Cof(Torque(5),m5,cm5_x);
%Regressor_Matrix (5,13) = Get_Cof(Torque(5),m5,cm5_y);
Regressor_Matrix (5,14) = Get_Cof(Torque(5),m5,cm5_z);
% Regressor_Matrix (5,15) = Get_Cof(Torque(5),m6,L3);
% Regressor_Matrix (5,16) = Get_Cof(Torque(5),m6,L4_z0);
...
% Regressor_Matrix (5,20) = Get_Cof(Torque(5),m7,L2);
% Regressor_Matrix (5,21) = Get_Cof(Torque(5),m7,L3);
% Regressor_Matrix (5,22) = Get_Cof(Torque(5),m7,L4_z0);
...
% Regressor_Matrix (6,2)  = Get_Cof(Torque(6),m2,cm2_x);
% Regressor_Matrix (6,3)  = Get_Cof(Torque(6),m2,cm2_y);
% Regressor_Matrix (6,4)  = Get_Cof(Torque(6),m3,L3);
% Regressor_Matrix (6,5)  = Get_Cof(Torque(6),m3,cm3_z);
% Regressor_Matrix (6,6)  = Get_Cof(Torque(6),m4,L3);
% Regressor_Matrix (6,7)  = Get_Cof(Torque(6),m4,cm4_y);
% Regressor_Matrix (6,8)  = Get_Cof(Torque(6),m4,cm4_x);
% Regressor_Matrix (6,9)  = Get_Cof(Torque(6),m4,cm4_z);
% Regressor_Matrix (6,10) = Get_Cof(Torque(6),m5,L3);
% Regressor_Matrix (6,11) = Get_Cof(Torque(6),m5,L4_z0);
% Regressor_Matrix (6,12) = Get_Cof(Torque(6),m5,cm5_x);
% Regressor_Matrix (6,13) = Get_Cof(Torque(6),m5,cm5_y);
% Regressor_Matrix (6,14) = Get_Cof(Torque(6),m5,cm5_z);
% Regressor_Matrix (6,15) = Get_Cof(Torque(6),m6,L3);
% Regressor_Matrix (6,16) = Get_Cof(Torque(6),m6,L4_z0);
Regressor_Matrix (6,17) = Get_Cof(Torque(6),m6,cm6_x);
% Regressor_Matrix (6,18) = Get_Cof(Torque(6),m6,cm6_y);
Regressor_Matrix (6,19) = Get_Cof(Torque(6),m6,cm6_z);
% Regressor_Matrix (6,20) = Get_Cof(Torque(6),m7,L2);
% Regressor_Matrix (6,21) = Get_Cof(Torque(6),m7,L3);
% Regressor_Matrix (6,22) = Get_Cof(Torque(6),m7,L4_z0);
...
% Regressor_Matrix (7,2)  = Get_Cof(Torque(7),m2,cm2_x);
% Regressor_Matrix (7,3)  = Get_Cof(Torque(7),m2,cm2_y);
% Regressor_Matrix (7,4)  = Get_Cof(Torque(7),m3,L3);
% Regressor_Matrix (7,5)  = Get_Cof(Torque(7),m3,cm3_z);
% Regressor_Matrix (7,6)  = Get_Cof(Torque(7),m4,L3);
% Regressor_Matrix (7,7)  = Get_Cof(Torque(7),m4,cm4_y);
% Regressor_Matrix (7,8)  = Get_Cof(Torque(7),m4,cm4_x);
% Regressor_Matrix (7,9)  = Get_Cof(Torque(7),m4,cm4_z);
% Regressor_Matrix (7,10) = Get_Cof(Torque(7),m5,L3);
% Regressor_Matrix (7,11) = Get_Cof(Torque(7),m5,L4_z0);
% Regressor_Matrix (7,12) = Get_Cof(Torque(7),m5,cm5_x);
% Regressor_Matrix (7,13) = Get_Cof(Torque(7),m5,cm5_y);
% Regressor_Matrix (7,14) = Get_Cof(Torque(7),m5,cm5_z);
% Regressor_Matrix (7,15) = Get_Cof(Torque(7),m6,L3);
% Regressor_Matrix (7,16) = Get_Cof(Torque(7),m6,L4_z0);
% Regressor_Matrix (7,17) = Get_Cof(Torque(7),m6,cm6_x);
% Regressor_Matrix (7,18) = Get_Cof(Torque(7),m6,cm6_y);
% Regressor_Matrix (7,19) = Get_Cof(Torque(7),m6,cm6_z);
% Regressor_Matrix (7,20) = Get_Cof(Torque(7),m7,L2);
% Regressor_Matrix (7,21) = Get_Cof(Torque(7),m7,L3);
% Regressor_Matrix (7,22) = Get_Cof(Torque(7),m7,L4_z0);
