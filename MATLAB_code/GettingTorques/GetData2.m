...
q_dis_l = [(q_mids(1)-q_min(1))/3 , (q_mids(2)-q_min(2))/3 , (q_mids(3)-q_min(3))/3 ,(q_mids(4)-q_min(4))/2 , (q_mids(5)-q_min(5))/2 , (q_mids(6)-q_min(6))/2 , (q_mids(7)-q_min(7))/2 , (q_mids(8)-q_min(8))/2]
q_dis_h = [(q_max(1)-q_mids(1))/3 , (q_max(2)-q_mids(2))/3 , (q_max(3)-q_mids(3))/3 ,(q_max(4)-q_mids(4))/2 , (q_max(5)-q_mids(5))/2 , (q_max(6)-q_mids(6))/2 , (q_max(7)-q_mids(7))/2 , (q_max(8)-q_mids(8))/2]
