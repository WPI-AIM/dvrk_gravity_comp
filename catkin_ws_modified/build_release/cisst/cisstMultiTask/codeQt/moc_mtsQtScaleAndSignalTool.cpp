...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_mtsQtScaleAndSignalTool_t, stringdata) + ofs \
...
const QMetaObject mtsQtScaleAndSignalTool::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_mtsQtScaleAndSignalTool.data,
      qt_meta_data_mtsQtScaleAndSignalTool,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mtsQtScaleAndSignalTool.stringdata))
        return static_cast<void*>(const_cast< mtsQtScaleAndSignalTool*>(this));
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_mtsQtScaleEditor_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
QT_MOC_LITERAL(6, 67, 5)
    ...
    "RenameScale\0ShowContextMenu\0point\0"
};
#undef QT_MOC_LITERAL
...
const QMetaObject mtsQtScaleEditor::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_mtsQtScaleEditor.data,
      qt_meta_data_mtsQtScaleEditor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mtsQtScaleEditor.stringdata))
        return static_cast<void*>(const_cast< mtsQtScaleEditor*>(this));
