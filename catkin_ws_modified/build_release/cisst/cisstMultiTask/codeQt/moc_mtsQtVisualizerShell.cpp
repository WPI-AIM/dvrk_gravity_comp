...
#include "../../../../src/cisst-saw/cisst/cisstMultiTask/mtsQtVisualizerShell.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_mtsQtVisualizerShell_t, stringdata) + ofs \
...
const QMetaObject mtsQtVisualizerShell::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_mtsQtVisualizerShell.data,
      qt_meta_data_mtsQtVisualizerShell,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mtsQtVisualizerShell.stringdata))
        return static_cast<void*>(const_cast< mtsQtVisualizerShell*>(this));
