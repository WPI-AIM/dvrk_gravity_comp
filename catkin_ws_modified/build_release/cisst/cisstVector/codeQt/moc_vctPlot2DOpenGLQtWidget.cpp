...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_vctPlot2DOpenGLQtWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 123, 29)
    ...
    "SetContinuousExpandYResetSlot\0"
};
...
const QMetaObject vctPlot2DOpenGLQtWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_vctPlot2DOpenGLQtWidget.data,
      qt_meta_data_vctPlot2DOpenGLQtWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_vctPlot2DOpenGLQtWidget.stringdata))
