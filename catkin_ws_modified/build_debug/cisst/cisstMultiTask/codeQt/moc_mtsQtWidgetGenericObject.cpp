...
#include "../../../../src/cisst-saw/cisst/cisstMultiTask/mtsQtWidgetGenericObject.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_mtsQtWidgetGenericObjectRead_t, stringdata) + ofs \
...
QT_MOC_LITERAL(0, 0, 28)
    ...
    "mtsQtWidgetGenericObjectRead\0"
};
...
const QMetaObject mtsQtWidgetGenericObjectRead::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_mtsQtWidgetGenericObjectRead.data,
      qt_meta_data_mtsQtWidgetGenericObjectRead,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mtsQtWidgetGenericObjectRead.stringdata))
        return static_cast<void*>(const_cast< mtsQtWidgetGenericObjectRead*>(this));
    if (!strcmp(_clname, "cmnGenericObject"))
        return static_cast< cmnGenericObject*>(const_cast< mtsQtWidgetGenericObjectRead*>(this));
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_mtsQtWidgetGenericObjectWrite_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
QT_MOC_LITERAL(0, 0, 29)
    ...
    "mtsQtWidgetGenericObjectWrite\0"
};
#undef QT_MOC_LITERAL
...
const QMetaObject mtsQtWidgetGenericObjectWrite::staticMetaObject = {
    { &mtsQtWidgetGenericObjectRead::staticMetaObject, qt_meta_stringdata_mtsQtWidgetGenericObjectWrite.data,
      qt_meta_data_mtsQtWidgetGenericObjectWrite,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mtsQtWidgetGenericObjectWrite.stringdata))
        return static_cast<void*>(const_cast< mtsQtWidgetGenericObjectWrite*>(this));
