...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_mtsQtWidgetComponent_t, stringdata) + ofs \
...
const QMetaObject mtsQtWidgetComponent::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_mtsQtWidgetComponent.data,
      qt_meta_data_mtsQtWidgetComponent,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mtsQtWidgetComponent.stringdata))
        return static_cast<void*>(const_cast< mtsQtWidgetComponent*>(this));
    if (!strcmp(_clname, "mtsComponent"))
        return static_cast< mtsComponent*>(const_cast< mtsQtWidgetComponent*>(this));
