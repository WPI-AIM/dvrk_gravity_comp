...
if("TRUE" STREQUAL "TRUE")
  set(rqt_dvrk_SOURCE_PREFIX /home/davincic2/catkin_ws/src/dvrk-ros/deprecated/rqt_dvrk)
  set(rqt_dvrk_DEVEL_PREFIX /home/davincic2/catkin_ws/devel_release/.private/rqt_dvrk)
  set(rqt_dvrk_INSTALL_PREFIX "")
  set(rqt_dvrk_PREFIX ${rqt_dvrk_DEVEL_PREFIX})
else()
  set(rqt_dvrk_SOURCE_PREFIX "")
  set(rqt_dvrk_DEVEL_PREFIX "")
  set(rqt_dvrk_INSTALL_PREFIX /home/davincic2/catkin_ws/install_release)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_dvrk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/davincic2/catkin_ws/src/dvrk-ros/deprecated/rqt_dvrk/${idir}'.  Ask the maintainer 'Zihan Chen <zihan.chen@jhu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/davincic2/catkin_ws/devel_release/.private/rqt_dvrk/lib;/home/davincic2/catkin_ws/devel_release/lib;/opt/ros/indigo/lib)
